  ...
  <xsl:template name="Listing" match="imovel">
    <Listing xmlns="http://www.vivareal.com/schemas/1.0/VRSync">
      <ListingID>
        ...
        <xsl:value-of select="detalhes/valordoimovel"/>
      </ListingID>
      <TransactionType>For Sale</TransactionType>
      <Title><xsl:value-of select="detalhes/tipodoimovel/tipo"/> (Ref. Lopes/Pronto: <xsl:value-of select="id"/>)</Title>
      <DetailViewUrl>
      ...
      <ContactInfo>
        <Email>
          <xsl:call-template name="comaSplit">
            <xsl:with-param name="string" select="franqueador/emaildofranqueador"/>
            <xsl:with-param name="pattern" select="';'"/>
          </xsl:call-template>
        </Email>
        <Name>
          <xsl:value-of select="franqueador/nomedofranqueador"/>
        </Name>
        <Website>
          <xsl:value-of select="franqueador/urldofranqueador"/>
        </Website>
        <Telephone>
          <xsl:value-of select="franqueador/telefonedofranqueador"/>
        </Telephone>
      </ContactInfo>
    </Listing>
  </xsl:template>
